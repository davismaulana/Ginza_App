  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(image: AssetImage("assets/images/rabusta.png"), fit: BoxFit.cover),
                          color: Colors.white
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Add Product', style: TextStyle(fontFamily: "Economica", fontSize: 25),),
